...
class splitbase():
    def __init__(self,
        ...
        self.thresh = thresh
        self.outimagepath = os.path.join(self.outdir, 'images')
        self.outlabelpath = os.path.join(self.outdir, 'annotations')
        ...
        with codecs.open(outdir, 'w', self.code) as f_out:
            for obj in objects:
                ...
                if half_iou == 1:
                    ...
                    polyInsub = list(map(str, polyInsub))
                    outline = polyInsub[0] + ' ' + \
                              polyInsub[1] + ' ' + \
                              polyInsub[4] + ' ' + \
                              polyInsub[5] + ' ' + \
    ...
    def SplitSingle(self, name, imagepath, objects, rate, extent):
        """
    ...
    def splitdata(self, datalist, rate):
        """
